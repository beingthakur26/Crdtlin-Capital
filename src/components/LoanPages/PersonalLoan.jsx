          ...
          <div className="p-8 md:p-12 lg:p-16">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-[var(--color-text-primary)] mb-8 leading-relaxed">
                Achieve your personal goals with our hassle-free personal loans.
                Whether it's for a dream wedding, medical emergency, or travel,
                we've got you covered with quick approvals and flexible terms.
              </p>
