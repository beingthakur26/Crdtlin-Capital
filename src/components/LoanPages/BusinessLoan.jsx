          ...
          <div className="p-8 md:p-12 lg:p-16">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-[var(--color-text-primary)] mb-8 leading-relaxed">
                Scale your business to new heights with our tailored business
                financing. From working capital to machinery purchase, we offer
                flexible solutions without collateral for eligible businesses.
              </p>
              ...
              <div>
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    "Flexible repayment options to match cash flow",
